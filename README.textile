...
You must have the "metric-fu gem":http://metric-fu.rubyforge.org/ installed, and you must have a rake task in your project (the default metricFu adds): metrics:all
